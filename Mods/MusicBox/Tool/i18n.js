const contents = {
    ...
    "tip3": ["使用命令模式时，将会生成给予你（@p）已经输入好内容的书与笔的命令，将其复制到命令方块中以使用。", "In \"Command\" mode, it will generate a command to give you(@p) a specific Book and Quill, copy it to command block to use."],
    "tip4": ["使用逐页导出模式时，将会把需要输入至书与笔中的内容在此处列出，你需要将其逐页复制到书与笔中。", "In \"Page-by-page\" mode, it will list the content that needs to be input into the Book and Quill here, you need to copy it page by page."],
...
const welcomeHtml = '<div style="color:white"><b><span accesskey="welcome"></span></b><p><span accesskey="description"></span><a href="https://github.com/C20C01/MusicBox"><span accesskey="learnMore"></span></a></p><br><br><br><b><span accesskey="tips"></span></b><ul><li><span accesskey="tip1"></span><a href="https://opennbs.org/">[OPEN NOTE BLOCK STUDIO]</a></li><li><span accesskey="tip2"></span></li><li><span accesskey="tip3"></span></li><li><span accesskey="tip4"></span></li><li><span accesskey="tip5"></span></li></ul></div>';
